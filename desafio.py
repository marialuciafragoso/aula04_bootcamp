#DESAFIO_4: Gerar funções no programa de bonus salarial
...
usuario = {"nome": pegar_nome(), 
           "salario": pegar_salario(),
           "bonus": pegar_bonus()}

usuario["bonus_valor"] = calcular_valor_do_bonus(usuario["salario"], usuario["bonus"])
usuario["salario_total"] = usuario["bonus_valor"] + usuario["salario"]

exibir_resultado(usuario)
